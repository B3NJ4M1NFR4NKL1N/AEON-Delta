"""
AEON-Delta RMT v3.1 — Test Control Panel
═════════════════════════════════════════
...
control over the unified test corpus (6 037 tests).
...
SUITE_REGISTRY: Tuple[TestSuite, ...] = (
    ...
    TestSuite(
        ...
        section=3,
        source="test_cognitive_patches.py",
        test_count=25,
    ...
    TestSuite(
        ...
        section=4,
        source="test_cognitive_activation_patches.py",
        test_count=37,
        categories=_fs(CognitiveCategory.COGNITIVE_ACTIVATION),
        series="activation",
    ...
    TestSuite(
        ...
        section=24,
        source="test_integration_patches.py",
        test_count=24,
        categories=_fs(CognitiveCategory.COMPONENT_INTEGRATION, CognitiveCategory.COGNITIVE_ACTIVATION),
        series="integration",
    ...
    TestSuite(
        ...
        section=25,
        source="test_final_integration.py",
        test_count=40,
        categories=_fs(CognitiveCategory.COMPONENT_INTEGRATION, CognitiveCategory.AGI_AXIOMS),
        series="final",
    ...
    TestSuite(
        ...
        section=26,
        source="test_final_activation_patches.py",
        test_count=39,
        categories=_fs(
            CognitiveCategory.COMPONENT_INTEGRATION,
            CognitiveCategory.COGNITIVE_ACTIVATION,
    ...
    TestSuite(
        ...
        section=27,
        source="test_g_series_patches.py",
        test_count=27,
        categories=_fs(CognitiveCategory.COMPONENT_INTEGRATION, CognitiveCategory.COGNITIVE_ACTIVATION),
        series="g_int",
    ...
    TestSuite(
        ...
        section=28,
        source="test_h_series_patches.py",
        test_count=31,
        categories=_fs(CognitiveCategory.COMPONENT_INTEGRATION, CognitiveCategory.COGNITIVE_ACTIVATION),
        series="h_int",
    ...
    TestSuite(
        ...
        section=29,
        source="test_i_series_patches.py",
        test_count=43,
    ...
    TestSuite(
        ...
        section=30,
        source="test_j_series_patches.py",
        test_count=42,
        categories=_fs(CognitiveCategory.COMPONENT_INTEGRATION),
        series="j_int",
    ...
    TestSuite(
        ...
        section=31,
        source="test_architectural_fixes.py",
        test_count=43,
    ...
    TestSuite(
        ...
        section=32,
        source="test_wizard_integration.py",
        test_count=46,
        categories=_fs(CognitiveCategory.COMPONENT_INTEGRATION, CognitiveCategory.LEARNING_ADAPTATION),
        series="wizard",
    ...
    TestSuite(
        ...
        section=33,
        source="test_self_play_wizard.py",
        test_count=64,
