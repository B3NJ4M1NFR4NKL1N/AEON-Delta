...
- **Comprehensive test runner**: catalogue of 3,190 tests, background execution with progress tracking, cancellation, and per-test SSE streaming
...
AEON-Δ includes a comprehensive test suite (`test_fixes.py`, 3,190 tests) verifying:
...
├── test_fixes.py         # Comprehensive test suite (3,190 tests) — stability, gradients, causal, planning, audit, recovery, coherence
